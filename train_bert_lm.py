...
# example:
# python train_bert_lm.py --word2vec_model_path=./data/word2vec/bert_word2vec.txt  --mask_lm_source_file=./data/bert_train.txt
...
def main(_):
    ...
    # 3. mask word random（得到：文本的word index序列, 被masked的word index, 被masked的word的正确下标位置）
    # what about generating next sentence data ?
